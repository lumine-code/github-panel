...
const EMPTY_CLASS = "github-panel-LumineTextEditor-empty";
...
export default class LumineTextEditor extends React.Component {
  ...
  render() {
    return (
      <Fragment>
        <div className="github-panel-LumineTextEditor-container" ref={this.refParent.setter} />
